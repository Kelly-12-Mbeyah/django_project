"""
Django settings for storeft project.
...
SECRET_KEY = 'django-insecure-el$=0p5c)iyh+axl6f%98piu^ehk16^(ey#w1al13ho&69+&qg'
...
WSGI_APPLICATION = 'storeft.wsgi.application'
